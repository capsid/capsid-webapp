...
CapsidFeatureTrack.prototype = new Track({});

function CapsidFeatureTrack(args) {
...
CapsidFeatureTrack.prototype.render = function(targetId) {
  var _this = this;
...
CapsidFeatureTrack.prototype.draw = function() {
  this.svgCanvasOffset = (this.width * 3 / 2) / this.pixelBase;
  this.svgCanvasLeftLimit = this.region.start - this.svgCanvasOffset * 2;
  this.svgCanvasRightLimit = this.region.start + this.svgCanvasOffset * 2
...
CapsidFeatureTrack.prototype.move = function(disp) {
  var _this = this;
...
CapsidFeatureTrack.prototype._getFeaturesByChunks = function(response) {
